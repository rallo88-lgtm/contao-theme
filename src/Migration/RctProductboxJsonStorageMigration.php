...
class RctProductboxJsonStorageMigration extends AbstractMigration
{
    private const FIELDS = [
        'rct_productbox_banner',
        'rct_productbox_color',
        'rct_productbox_slide_speed',
        'rct_productbox_layout',
        'rct_productbox_stock',
        'rct_productbox_stock_label',
        'rct_productbox_price_old',
        'rct_productbox_image_alt',
        'rct_productbox_headline',
        'rct_productbox_subheadline',
        'rct_productbox_text',
        'rct_productbox_style',
        'rct_productbox_price_extra',
        'rct_productbox_price',
        'rct_productbox_price_note',
        'rct_productbox_btn_label',
        'rct_productbox_btn_url',
        'rct_productbox_btn_style',
        'rct_productbox_btn_target',
    ];
    private const CE_TYPES = ['rct_productbox'];

    public function __construct(private readonly Connection $db) {}

    public function getName(): string
    {
        return 'RCT Bundle – rct_productbox fields to jsonData column';
    }
    ...
    public function shouldRun(): bool
    {
        ...
        $unmigrated = (int) $this->db->fetchOne(
            "SELECT COUNT(*) FROM tl_content
             ...
             AND (jsonData IS NULL OR JSON_EXTRACT(jsonData, '$.rct_productbox_color') IS NULL)",
            self::CE_TYPES
        );
        return $unmigrated > 0;
    }
    ...
    public function run(): MigrationResult
    {
        ...
        return $this->createResult(
            true,
            sprintf('rct_productbox → jsonData: %d Element(e) migriert.', $touched)
        );
    }
}
