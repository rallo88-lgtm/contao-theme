...
class RctGalleryJsonStorageMigration extends AbstractMigration
{
    private const FIELDS = [
        ...
        'rct_gallery_sortby',
        'rct_gallery_filter',
        'rct_gallery_lightbox',
    ];
    private const CE_TYPES = ['rct_gallery'];

    public function __construct(private readonly Connection $db) {}

    public function getName(): string
    {
        return 'RCT Bundle – rct_gallery fields to jsonData column';
    }
    ...
    public function shouldRun(): bool
    {
        ...
        $unmigrated = (int) $this->db->fetchOne(
            "SELECT COUNT(*) FROM tl_content
             ...
             AND (jsonData IS NULL OR JSON_EXTRACT(jsonData, '$.rct_gallery_layout') IS NULL)",
            self::CE_TYPES
        );
        return $unmigrated > 0;
    }
    ...
    public function run(): MigrationResult
    {
        ...
        return $this->createResult(
            true,
            sprintf('rct_gallery → jsonData: %d Element(e) migriert.', $touched)
        );
    }
}
