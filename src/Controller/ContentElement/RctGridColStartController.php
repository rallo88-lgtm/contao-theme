...
#[AsContentElement(type: 'rct_grid_col_start', category: 'rct', template: 'content_element/rct_grid_col_start')]
class RctGridColStartController extends AbstractContentElementController
{
